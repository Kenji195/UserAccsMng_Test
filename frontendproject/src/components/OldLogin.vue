                    ...
                    <v-row>
                      ...
                      <div style="  text-align: center; padding: 180px 0;">
                        <v-card-text class="white--text" >
                          ...
                          <h5
                            class="text-center"
                          >Let's get you all set up so you can start creating your your first<br>  onboarding experience</h5>
                        </v-card-text>
                      ...
                      <v-col cols="12" md="6" class="blue rounded-br-xl">
                       <div style="  text-align: center; padding: 180px 0;">
                        <v-card-text class="white--text" >
                          ...
                          <h5
                            class="text-center"
                          >Log in to your account so you can continue building and<br>  editing your onboarding flows</h5>
                        </v-card-text>
                        <div class="text-center">
